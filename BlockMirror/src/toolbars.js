...
TOOLBOX_CATEGORY.DECISIONS = {name: "条件判断", colour: "LOGIC", blocks: [
    'if ___: pass',
    'if ___: pass\nelse: pass',
    '___ < ___',
    '___ and ___',
...
TOOLBOX_CATEGORY.TURTLES = {name: "海龟作图", colour: "PLOTTING", blocks: [
    "turtle.mainloop()",
    "turtle.forward(50)",
    "turtle.backward(50)",
    "turtle.right(90)",
...
TOOLBOX_CATEGORY.VALUES = {name: "值", colour: "TEXT", blocks: [
    '""',
    "0",
    "True"
]};
...
BlockMirrorBlockEditor.prototype.TOOLBOXES = {
    ...
    'ct2': [
        ...
        '<category name="表达式" expanded="true">',
